    ...
    <div >
      {cart.length > 0 ? (
          ...
          <div className="w-[100%] md:w-[40%] mt-5  flex flex-col">
            ...
            <div className="font-semibold text-xl text-green-800 ">Your Cart</div>
              ...
              <p className="text-xl">
                ...
                font-semibold text-xl">Total Items: {cart.length}</span>
              </p>
            </div>
            </div>
            ...
            <div className="flex flex-col">
              ...
              ease-linear mt-5 border-2 border-green-600 font-bold 
        ...
        <div className="min-h-[80vh] flex flex-col items-center justify-center">
          ...
          <Link to={"/"}>
            <button className="uppercase bg-green-600 hover:bg-purple-50 rounded-lg
